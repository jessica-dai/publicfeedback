...
### Workshop info
August 17–18, 2026 ⋅ Berkeley, CA

***Questions?*** email [Jessica Dai](https://www.jessicad.ai/){:target="_blank"} / jessicadai@berkeley.edu
...
| 10:00am | <input type="checkbox" id="s1-toggle" class="row-toggle-input"><label for="s1-toggle" class="row-toggle-label">Session 1: ***What are we doing here?***</label><span class="row-detail">• **Crowdsourced Evaluations for Safety and Societal Impact** ([Jessica Dai](https://www.jessicad.ai/){:target="_blank"})<br>• **Individual Experience vs. the Cochrane Review** ([Ben Recht](https://www.argmin.net/){:target="_blank"})<br>• **Public Feedback and Public Policy: How Collecting and Monitoring AI Public Feedback Can Feed into Meaningful Legal and Regulatory Practice** ([Deb Raji](https://rajiinio.github.io/){:target="_blank"})</span> |
| 11:15am | <span class="placeholder">break</span> |
| 11:30am | <input type="checkbox" id="s2-toggle" class="row-toggle-input"><label for="s2-toggle" class="row-toggle-label">Session 2: ***What does the public want?***</label><span class="row-detail">• **AI research has become misaligned with what people want from AI** ([Emma Pierson](https://people.eecs.berkeley.edu/~emmapierson/){:target="_blank"})<br>• **Developing Grassroots Capacity for Deliberations on AI** ([Humphrey Obuobi](https://www.linkedin.com/in/hobuobi/){:target="_blank"})<br>• **Data Centers & Democratic Input** ([Jasmine Sun](https://jasmi.news/){:target="_blank"})</span> |
...
|------|----------|
| 9:00am | <span class="placeholder">breakfast & mingling</span> |
| 10:00am | <input type="checkbox" id="s5-toggle" class="row-toggle-input"><label for="s5-toggle" class="row-toggle-label">Session 5: ***Statistical & algorithmic perspectives***</label><span class="row-detail">• **Algorithmic Hooks for Participatory Machine Learning** ([Ira Globus-Harris](https://globusharris.github.io/){:target="_blank"})<br>• **Gathering Evidence Under Resource-Information Constraints** ([Sarah Cen](https://shcen.github.io/){:target="_blank"})<br>• **Understanding Human Perception of Representation in Citizens' Assemblies: An Empirical Study** ([Evi Micha](https://evi-micha.github.io/index.html){:target="_blank"})</span> |
| 11:15am | <span class="placeholder">break</span> |
| 11:30am | <input type="checkbox" id="s6-toggle" class="row-toggle-input"><label for="s6-toggle" class="row-toggle-label">Session 6: ***Where do we get the data?***</label><span class="row-detail">• **Charting the Landscape of Human-AI Interaction Data: User Studies, In-the-Wild Logs, and the Role of Public Feedback** ([Serina Chang](https://serinachang5.github.io/){:target="_blank"})<br>• **Crowdsourcing as Evaluation, Crowdsourcing as Intervention** ([Eve Fleisig](https://www.efleisig.com/){:target="_blank"})<br>• **Towards Participatory, Privacy-Preserving Measurement of Naturalistic AI Use** ([Cathy Fang](https://cathy-fang.com/index.html){:target="_blank"})</span> |
| 12:45pm | <span class="placeholder">catered lunch</span> |
...
<details markdown="1">
<summary>Confirmed attendees</summary>

- [Zoë Bell](https://sites.google.com/berkeley.edu/zoebell/){:target="_blank"} (UC Berkeley)
- [Emily Byun](https://yewonbyun.github.io/){:target="_blank"} (Carnegie Mellon)
- [Sarah Cen](https://shcen.github.io/){:target="_blank"} (Carnegie Mellon)
- [Serina Chang](https://serinachang5.github.io/){:target="_blank"} (UC Berkeley)
- [Irene Chen](https://irenechen.net/){:target="_blank"} (UC Berkeley/UCSF)
- [Samantha Dalal](https://www.samantha-dalal.com/){:target="_blank"} (Princeton)
- [Wesley Deng](https://wesleydeng.com/){:target="_blank"} (Microsoft Research)
- [Cathy Fang](https://cathy-fang.com/index.html){:target="_blank"} (MIT)
- [Avi Feller](https://www.avifeller.com/){:target="_blank"} (Berkeley)
- [Kevin Feng](https://kjfeng.me/#/){:target="_blank"} (University of Washington)
...
- [Jivat Kaur](https://jivatneet.github.io/){:target="_blank"} (UC Berkeley)
...
- [Ryan Lehmkuhl](https://ryanleh.me/){:target="_blank"} (UC Berkeley)
...
- [Ben Recht](https://www.argmin.net/){:target="_blank"} (UC Berkeley)
- [Joal Stein](https://x.com/JoalStein){:target="_blank"} (Collective Intelligence Project)
...
- [Annie Ulichney](https://aulichney.github.io/){:target="_blank"} (UC Berkeley)
