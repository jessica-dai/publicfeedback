...
| 11:30am | <input type="checkbox" id="s2-toggle" class="row-toggle-input"><label for="s2-toggle" class="row-toggle-label">Session 2: ***Public participation***</label><span class="row-detail">• **From AI Consumers to Civic Actors: Toward an "AI Civics"** ([Meg Young](https://publictech.space/){:target="_blank"})<br>• **Developing Grassroots Capacity for Deliberations on AI** ([Humphrey Obuobi](https://www.linkedin.com/in/hobuobi/){:target="_blank"})<br>• **Data Centers & Democratic Input** ([Jasmine Sun](https://jasmi.news/){:target="_blank"})</span> |
...
| 11:15am | <span class="placeholder">break</span> |
| 11:30am | <input type="checkbox" id="s6-toggle" class="row-toggle-input"><label for="s6-toggle" class="row-toggle-label">Session 6: ***Where do we get the data?***</label><span class="row-detail">• **Charting the Landscape of Human-AI Interaction Data: User Studies, In-the-Wild Logs, and the Role of Public Feedback** ([Serina Chang](https://serinachang5.github.io/){:target="_blank"})<br>• **Crowdsourcing as Evaluation, Crowdsourcing as Intervention** ([Eve Fleisig](https://www.efleisig.com/){:target="_blank"})
<br>• **AI research has become misaligned with what people want from AI** ([Emma Pierson](https://people.eecs.berkeley.edu/~emmapierson/){:target="_blank"})</span> |
| 12:45pm | <span class="placeholder">catered lunch</span> |
